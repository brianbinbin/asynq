...
import (
	...
	"github.com/brianbinbin/asynq/internal/base"
	"github.com/go-redis/redis/v7"
	"github.com/google/go-cmp/cmp"
)

// TODO(brianbinbin): Get Redis address and db number from ENV variables.
...
func TestKill(t *testing.T) {
	...
	// TODO(brianbinbin): add test cases for trimming
	tests := []struct {
		inProgress     []*base.TaskMessage
		dead           []h.ZSetEntry
